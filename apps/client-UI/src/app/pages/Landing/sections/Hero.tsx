...
function Hero() {
  return (
    <main className="relative min-h-screen bg-gradient-to-br from-[#ff6b6b] via-[#ff8e8e] to-[#ffe0e0] text-white overflow-hidden">
      ...
      <section className="relative h-[80vh] px-10 pb-10 pt-10">
        {/* Background word */}
        <h1 className="pointer-events-none select-none absolute inset-x-0 top-16 lg:text-[9rem] tracking-widest text-center font-black text-white/40">
          KIDDO
        </h1>

        {/* bottom row: left text + center avatar + right cards */}
        <div className="absolute inset-x-10 flex items-end justify-between gap-8 ">
          {/* LEFT: text block */}
          ...
          <div className="flex-1 flex justify-center">
            <img src="./landing_Avatar2.png" alt="" />
          </div>

          {/* RIGHT: cards */}
          <div className="hidden mb-16 md:flex flex-row gap-4">
            <div className=" w-52 h-52 rounded-2xl bg-white/90 p-4 text-sm text-[#e9344c] shadow-xl">
              <h3 className="font-semibold">Kindness Quests</h3>
              <p className="mt-1 text-xs text-gray-700">
                Short stories and missions that help kids practise gratitude,
                sharing, and empathy.
              </p>
              <span className="mt-2 inline-block text-xs font-semibold text-[#e9344c]">
                Try a quest →
              </span>
            </div>

            <div className="w-52 rounded-2xl bg-white/90 p-4 text-sm text-[#e9344c] shadow-xl">
              <h3 className="font-semibold">Brain & Health Boost</h3>
              <p className="mt-1 text-xs text-gray-700">
